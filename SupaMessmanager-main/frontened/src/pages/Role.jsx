...
function Role() {
  ...
  <div className="w-24 h-24 flex items-center justify-center text-9xl font-bold">
    🧑‍🍳
  </div>

  {/* Inner Orbit (radius 110px, faster) */}
<OrbitingCircles radius={-140} duration={0}>
  <div className="w-22 h-22 flex items-center justify-center text-6xl">🍔</div>
</OrbitingCircles>

<OrbitingCircles radius={-230} duration={0}>
  <div className="w-22 h-22 flex items-center justify-center text-6xl">🥗</div>
</OrbitingCircles>

<OrbitingCircles radius={130} duration={0}>
  <div className="w-22 h-22 flex items-center justify-center text-6xl">🍕</div>
</OrbitingCircles>

<OrbitingCircless radius={210} duration={0}>
  <div className="w-22 h-22 flex items-center justify-center text-6xl">🥤</div>
</OrbitingCircless>

{/* Outer Orbit (radius 210px, slower) */}
<OrbitingCircless radius={130} duration={0}>
  <div className="w-22 h-22 flex items-center justify-center text-6xl">🍉</div>
</OrbitingCircless>
